...
INSERT INTO `__new_widget_metric`("id", "order", "provider", "objective_id", "github_username", "github_stat_type", "style", "name", "value_aggregation_type", "value_display_precision", "widget_id", "user_id", "created_at") SELECT "id", "order", "provider", "objective_id", "github_username", "github_stat_type", "style", "name", "value_aggregation_type", "value_display_precision", "widget_id", "user_id", "created_at" FROM `widget_metric`;--> statement-breakpoint
